...
def main():
    parser = argparse.ArgumentParser(
        description="Runner", formatter_class=argparse.RawTextHelpFormatter
    )
    ...
    with mlflow.start_run() as r:
        ...
        building_run = mlflow.run(
            ...
            parameters={
                ...
                "dockerimage": f"cwryu6252/ml-system-design-pattern:training_pattern_cifar10_evaluate_{mlflow_experiment_id}",
            },
        )
