...
class Classifier(object):
    def __init__(self, model_filepath: str, label_filepath: str) -> None:
    ...
    def load_model(self):
        ...
        self.classfier = rt.InferenceSession(self.model_filepath)
        self.input_name = self.classfier.get_inputs()[0].name
        self.output_name = self.classfier.get_outputs()[0].name
    ...
    def predict(self, data: List[List[int]]) -> np.ndarray:
        ...
        prediction = self.classfier.run(None, {self.input_name: np_data})
